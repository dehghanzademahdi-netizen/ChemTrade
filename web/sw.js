...
self.addEventListener('fetch',event=>{
  ...
  if(url.hostname.includes('firebaseio.com')||url.hostname.includes('gstatic.com')||url.pathname.endsWith('/app.js')||url.pathname.endsWith('/index.html'))return;
