...
self.addEventListener('fetch',event=>{
  ...
  if(url.hostname.includes('firebaseio.com')||url.hostname.includes('gstatic.com')||url.pathname.endsWith('/app.js')||url.pathname.endsWith('/app-v2.js')||url.pathname.endsWith('/sw.js')) return;
